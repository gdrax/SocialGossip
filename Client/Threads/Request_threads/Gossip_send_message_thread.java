...
import Messages.Client_side.Action_messages.Gossip_action_msg_message;
...
public class Gossip_send_message_thread extends Gossip_client_thread {
	...
	String receiver; //nome del destinatario del messaggio
	String text; //contenuto del messaggio
	Gossip_friend_chat_listener chat; //listener della chat son amico
