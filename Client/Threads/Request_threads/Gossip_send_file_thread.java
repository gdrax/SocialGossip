...
import Messages.Client_side.Action_messages.Gossip_action_file_message;
...
public class Gossip_send_file_thread extends Gossip_client_thread {
	...
	private String receiver; //nome del destinatario del file
	private String filename; //nome del file
	private Gossip_friend_chat_listener chat; //listener della chat con amico
	private File file;
	...
	private boolean checkFile() {
		...
		//controllo se il file esiste ed è regolare
